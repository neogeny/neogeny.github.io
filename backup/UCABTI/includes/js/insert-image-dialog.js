...
AJS.toInit(function ($) {
    ...
    AJS.Editor.openImageDialog = function (options) {
        ...
        var dialogTitle = AJS.I18n.getText(options.imageProperties ? "image.browser.edit.title" : "image.browser.insert.title");
        var submitText = AJS.I18n.getText(options.imageProperties ? "image.browser.edit.button" : "image.browser.insert.button");
        ...
        popup.show();
        popup.popup.element.find(".dialog-button-panel").append(AJS.renderTemplate("insert-image-help-link"));
