 ...
 */
AJS.Confluence.Binder.autocompleteUser = function() {
    var $ = AJS.$;
    ...
    $("input.autocomplete-user[data-processed!=true]").each(function() {
        var $this = $(this)
        ...
        $this.quicksearch(AJS.REST.getBaseUrl() + "search/user.json",
            ...
            ajsDropDownOptions : {
                ...
                selectionHandler: function (e, selection) {
                    ...
                    if (selection.hasClass("search-for")) {
                        $this.trigger("selected.autocomplete-user", { searchFor: $this.val() });
                        return;
                    }
                    if (selection.hasClass("no-results")) {
                        this.hide();
                        e.preventDefault();
                        return;
                    }
